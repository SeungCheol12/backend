...
public class MovieService {
    ...
    public PageResultDTO<MovieDTO> getMovieList(PageRequestDTO pageRequestDTO) {
        Pageable pageable = PageRequest.of(pageRequestDTO.getPage() - 1,
                pageRequestDTO.getSize(), Sort.by("mno").descending());
        // [Movie(mno=100, title=Movie Title 100), MovieImage(inum=303,
        // uuid=b7ada148-842f-4370-a871-3099c7aa03a9, path=null, imgName=test0.jpg,
        // ord=0), 2, 2.0]
        Page<Object[]> result = movieRepository.getListPage(pageable);

        // List<MovieDTO> list = new ArrayList<>(); // 방법 1
        // result.forEach(obj -> {
        ...
        Function<Object[], MovieDTO> function = (obj -> entityToDto((Movie) obj[0], // 방법 2
